    ...
    <div>
      <div className="container-kws">
        ...
        <div className="t-a-c m-y-2">
          Where we are on a mission to drive Malaysia's digital transformation
          and make a mark on the global stage. Our resolute commitment lies in
          spearheading innovative solutions that harness the power of
          decentralized technologies, with a keen focus on addressing the unique
          needs of the Islamic Fintech sector.
        </div>
        ...
        <div className="section">
          ...
          <div className="section">
            ...
            <div className="d-f j-c-c g-2 flex-wrap">
              ...
              <div className="f-s-1_25 f-w-600">
                Darlitana UAB (Shariah compliant digital asset exchange)
              </div>
              <div className="f-s-1_25 f-w-600">
                {" "}
                GC Trust KB (Islamic Fintech)
              </div>
              <div className="f-s-1_25 f-w-600">
                {" "}
                GC Global Finance Ltd. (Islamic Fintech)
              </div>
              <div className="f-s-1_25 f-w-600"> UBB Investment Bank Ltd.</div>
              <div className="f-s-1_25 f-w-600"> Tijarah Holding Ltd. </div>
            </div>
          </div>
        </div>
      </div>
